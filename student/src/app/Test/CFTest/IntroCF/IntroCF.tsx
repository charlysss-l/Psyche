...
const IntroCF: React.FC = () => {
  ...
  return (
    <div className={styles.container}>
     ...
     <h1 className={styles.cfintro}>{introTitle}</h1>
      <p className={styles.cfintroinfo}>
  {introText.split('\n').map((line, index) => (
...
<h1 className={styles.termsandconditioncf}>{termsTitle}</h1>
<p className={styles.cftermsinfo}>
  {termsText.split('\n').map((line, index) => {
    ...
    return (
      ...
      {/* Test Start Button */}
      <div className={styles.Testcf}>
        <button onClick={handleStartClick} className={styles.cfButton} disabled={hasTakenTestToday}>
