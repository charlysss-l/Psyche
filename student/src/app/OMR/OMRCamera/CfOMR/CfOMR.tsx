...
import styles from './CfOMR.module.scss'; // Import SCSS styles
import { useNavigate } from 'react-router-dom';
import Tesseract from 'tesseract.js';
import cftestUrl from '../../../../cftestConfig';
  ...
  const handleUpload = async () => {
   ...
   if (uploadCount >= 10) {
    ...
    try {
      ...
      if (!isPortrait) {
        alert('Please upload a portrait-oriented CF answer sheet.');
        setLoading(false);  // Hide loading spinner on failure
        return;
      }
  
      // Validate if the image contains "CF"
  ...
  return (
    <div className={styles.mainContainer}>
      ...
      <div className={styles.instructionContainer}>
        ...
        <p>3. Upload a clear image of the CF Test Answer Sheet to the system by clicking the "Upload Image" button.</p>
