// LandingPageGuidance.tsx
import React from 'react';
import { Link } from 'react-router-dom';
import styles from './landingpageguidance.module.scss';

const LandingPageGuidance: React.FC = () => {
  return (
...
export default LandingPageGuidance; // Ensure this export is correct.
