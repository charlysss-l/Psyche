...
exports.deleteArchivedPFTestResult = exports.getArchivedPFTests = exports.archivePFTestResult = exports.deleteUser16PFTest = exports.updateUser16PFTest = exports.getUser16PFTestById = exports.getUser16PFTestByTestID = exports.getUser16PFTestByUserId = exports.getUser16PFTests = exports.createUser16PFTest = void 0;
...
const createUser16PFTest = async (req, res) => {
    ...
    try {
        ...
        const existingTest = await User16PFTestSchema_1.default.findOne({ testID });
        if (existingTest) {
...
const getUser16PFTestByUserId = async (req, res) => {
    ...
    try {
        ...
        const userTests = await User16PFTestSchema_1.default.find({ userID });
        ...
        return res.status(500).json({ message: 'Error fetching test', error: error.message });
    }
};
exports.getUser16PFTestByUserId = getUser16PFTestByUserId;
const getUser16PFTestByTestID = async (req, res) => {
    ...
    try {
        ...
        // Query the User16PFTest collection for the specific userID
        const userTests = await User16PFTestSchema_1.default.find({ testID });
        // Check if any tests were found
        if (!userTests || userTests.length === 0) {
            return res.status(404).json({ message: 'No tests found for this user' });
        }
...
exports.getUser16PFTestByTestID = getUser16PFTestByTestID;
...
const deleteUser16PFTest = async (req, res) => {
    ...
    try {
        const deletedIQTestResult = await User16PFTestSchema_1.default.findOneAndDelete({ testID: id });
...
const archivePFTestResult = async (req, res) => {
    ...
    try {
        ...
        const testResult = await User16PFTestSchema_1.default.findOne({ testID: testID });
        if (!testResult) {
...
const getArchivedPFTests = async (req, res) => {
    try {
        const archivedTests = await User16PFTestSchema_1.default.find({ isArchived: true });
...
const deleteArchivedPFTestResult = async (req, res) => {
    const { testID } = req.params;
    try {
        const consultationRequest = await User16PFTestSchema_1.default.findOne({ testID });
        if (!consultationRequest) {
            return res.status(404).json({ message: 'Consultation request not found' });
        }
        // Delete the consultation request
        await User16PFTestSchema_1.default.deleteOne({ testID });
