...
router.post('/tests', UserIQTestController_1.createIQTestResult);
// Route to retrieve all IQ test results for a specific user
router.get('/tests', UserIQTestController_1.getIQTestResultsByUser);
// Route to retrieve a specific IQ test result by test ID
router.get('/tests/:id', UserIQTestController_1.getIQTestResultById);
// Route to update an IQ test result by test ID
router.put('/tests/:id', UserIQTestController_1.updateIQTestResult);
// Route to delete an IQ test result by test ID
router.delete('/tests/:id', UserIQTestController_1.deleteIQTestResult);
